module.exports = function(nodemiral) {
  ...
  nodemiral.registerTask('download', download);
...
function download(session, options, callback, varsMapper) {
  session.download(options.src, options.dest, options, sendCallback(callback, varsMapper));
}
